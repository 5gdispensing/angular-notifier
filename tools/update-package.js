...
const distPackageJson = JSON.parse(fs.readFileSync('./dist/angular14-notifier/package.json').toString());
...
fs.writeFileSync('./dist/angular14-notifier/package.json', JSON.stringify(distPackageJson, null, '  '));
